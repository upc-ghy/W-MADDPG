...
from init_input.init_edge_node import init_fixed_edge_node_10, init_edge_vehicle_node
from config.config import settings
from init_input.init_task_by_time import init_task_by_time_10
from init_input.init_vehicles import get_edge_vehicle_id, get_customer_vehicle_id, get_vehicle_id_10
...
def process_wrapper(customer_vehicle_id, fixed_edge_node):
    ...
    task_by_time = init_task_by_time_10(customer_vehicle_id=customer_vehicle_id)
...
if __name__ == '__main__':
    ...
    fixed_edge_node = init_fixed_edge_node_10()
    ...
    customer_vehicle_id = get_vehicle_id_10()
