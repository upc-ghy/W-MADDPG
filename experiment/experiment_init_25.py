...
from init_input.init_distance import get_task_id_under_edge_node_25, get_task_time_limitation_under_edge_node_25
...
def save(iteration):
    ...
    #         if fixed_distance_matrix_list[i][j] <= 400:
    ...
    for i in range(settings.RSU_NUM_25):
    ...
    for i in range(settings.RSU_NUM_25):
        ...
        task_id_under_edge_node = get_task_id_under_edge_node_25(node_type=settings.NODE_TYPE_RSU,
                                                              node_id=i,
    ...
    for i in range(settings.RSU_NUM_25):
        ...
        task_time_limitation_under_edge_node = get_task_time_limitation_under_edge_node_25(
            iteration=iteration,
