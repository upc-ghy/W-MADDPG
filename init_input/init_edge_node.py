...
def init_fixed_edge_node_10():
    ...
    # for i in range(settings.base_station_num):
        ...
        #                     channel_num=settings.base_station_sub_channel_num)}
        # fixed_edge_node.append(base_station)
    for j in range(settings.rsu_num_10):
        rsu = {"id": j,
               "x": settings.rsu_x_10[j],
               "y": settings.rsu_y_10[j],
               "radius": settings.rsu_communication_radius,
               "channel_num": settings.rsu_sub_channel_num,
               "sub_channel": generate_random_sub_channel(
                   sub_channel_num=settings.sub_channel_num,
...
def init_fixed_edge_node_15():
    ...
    """
    fixed_edge_node = []
    for j in range(settings.rsu_num_15):
        rsu = {"id": j,
               "x": settings.rsu_x_15[j],
               "y": settings.rsu_y_15[j],
               "radius": settings.rsu_communication_radius,
               "channel_num": settings.rsu_sub_channel_num,
               "sub_channel": generate_random_sub_channel(
                   sub_channel_num=settings.sub_channel_num,
...
def init_fixed_edge_node_20():
    ...
    """
    fixed_edge_node = []
    for j in range(settings.rsu_num_20):
        rsu = {"id": j,
               "x": settings.rsu_x_20[j],
               "y": settings.rsu_y_20[j],
               "radius": settings.rsu_communication_radius,
               "channel_num": settings.rsu_sub_channel_num,
               "sub_channel": generate_random_sub_channel(
                   sub_channel_num=settings.sub_channel_num,
...
def init_fixed_edge_node_25():
    ...
    """
    fixed_edge_node = []
    for j in range(settings.rsu_num_25):
        rsu = {"id": j,
               "x": settings.rsu_x_25[j],
               "y": settings.rsu_y_25[j],
               "radius": settings.rsu_communication_radius,
               "channel_num": 6,
               "sub_channel": generate_random_sub_channel(
                   sub_channel_num=6,
