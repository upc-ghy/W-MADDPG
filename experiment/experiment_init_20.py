...
from init_input.init_distance import get_task_id_under_edge_node_20, get_task_time_limitation_under_edge_node_20
...
def save(iteration):
    ...
    pickle_file = Path(load_pickle(31))
    ...
    for i in range(settings.RSU_NUM_20):
    ...
    for i in range(settings.RSU_NUM_20):
        ...
        task_id_under_edge_node = get_task_id_under_edge_node_20(node_type=settings.NODE_TYPE_RSU,
                                                              node_id=i,
    ...
    for i in range(settings.RSU_NUM_20):
        ...
        task_time_limitation_under_edge_node = get_task_time_limitation_under_edge_node_20(
            iteration=iteration,
