...
from init_input.init_distance import get_task_id_under_edge_node_10, get_task_time_limitation_under_edge_node_10
...
def save(iteration):
    ...
    for i in range(settings.RSU_NUM_10):
    ...
    for i in range(settings.RSU_NUM_10):
        ...
        task_id_under_edge_node = get_task_id_under_edge_node_10(node_type=settings.NODE_TYPE_RSU,
                                                              node_id=i,
    ...
    for i in range(settings.RSU_NUM_10):
        ...
        task_time_limitation_under_edge_node = get_task_time_limitation_under_edge_node_10(
            iteration=iteration,
